...
# モデルの読み込み
model = tf.keras.models.load_model('flower_classifier_model_nitenai.keras')

# 画像の前処理と予測
img_dir = 'C:\\Users\\USER\\OneDrive - 文教大学\\ドキュメント\\test\\picture\\tome ookinkeigiku'
...
class_labels = {0: 'ヒルザキツキミソウ', 1: 'オオキンケイギク', 2: 'ペンタス'}
